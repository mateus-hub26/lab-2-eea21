...
A tabela verdade para o Codificador de Prioridade 4x2 é apresentada na Tabela \ref{tab:CodPriority}.
...
Após isso, foi realizado o esquemático utilizando o software Quartus, resultando no diagrama mostrado na Figura \ref{fig:CodPriority}.
...
Após a realização do esquemático, foi feita a simulação funcional, resultando no diagrama de temporização mostrado na Figura \ref{fig:TempoCodPriority}.
