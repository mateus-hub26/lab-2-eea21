...
A partir do que foi fornecido, foi possível realizar a construção da tabela verdade, como mostrado a seguir:
...
Para o esquemático, foi utilizado o software Quartus, resultando no diagrama mostrado na Figura \ref{fig:CodGray}.
...
Após a realização do esquemático, foi possível realizar a simulação funcional, mostrada na Figura \ref{fig:SimulacaoExercicio2}.
